    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('assets/img/bros-cash.png') }}"
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item theme-toggle" id="themeToggle"
                    ...
                    <i class="bi bi-moon-stars text-dark" id="theme-icon"></i>
                </div>
